...
const COPY = {
  ru: {
    ...
    p:
      "Лендинг, бот в Телеграме, CRM, личный кабинет или автоматизация — подберём решение под вашу задачу, а не будем навязывать лишнюю разработку.\n\n" +
              ...
              <div className="flex h-full w-full items-center justify-center text-center">
                ...
                >
                  ...
                  <div className="px-1 sm:px-0">
                    ...
                    <h2 className="mt-2.5 whitespace-pre-line text-balance text-[20px] font-[850] leading-[1.06] tracking-[-0.02em] text-white sm:mt-4 sm:text-[40px]">
                      {t.h}
                    </h2>
