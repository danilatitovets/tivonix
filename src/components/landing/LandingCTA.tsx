...
function ctaClass(variant: Props["variant"], size: Props["size"], className?: string) {
  ...
  return cx(
    ...
    variant === "plain" &&
      "border-0 bg-transparent font-medium text-white/88 hover:bg-white/[0.04] hover:text-white",
    variant === "white" &&
      "border-0 bg-white font-medium text-[#070607] shadow-none hover:bg-white/92",
    className
  );
}
