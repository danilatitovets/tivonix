    ...
    () => [
      {
        ...
        titleRu: "ЗАПУСК",
        titleEn: "LAUNCH",
        subtitleRu: "Быстрый старт: лендинг + Telegram-бот",
        subtitleEn: "Fast start: landing + Telegram bot",
        ctaRu: "Рассчитать стоимость",
        ctaEn: "Get a quote",
        noteRu: "Ответим в течение дня",
        noteEn: "Reply within 24h",
        descRu: "Запуск под ключ: конверсионный лендинг + бот для заявок и поддержки.",
        descEn: "Launch package: conversion landing + bot for leads and support.",
        bulletsRu: [
          "Лендинг под рекламу и конверсию",
          "Бот: сценарии, меню, команды",
          "Интеграции: CRM / Google / Notion",
          "Адаптив, базовое SEO, скорость",
        ],
        bulletsEn: [
      ...
      },
      {
        ...
        titleRu: "ПРОДУКТ",
        titleEn: "PRODUCT",
        subtitleRu: "MVP / кабинет / админка",
        subtitleEn: "MVP / dashboard / admin panel",
        ctaRu: "Рассчитать стоимость",
        ctaEn: "Get a quote",
        noteRu: "Оценка за 24 часа",
        noteEn: "Estimate in 24h",
        descRu: "Большие проекты: MVP, кабинеты, админ-панели, роли, базы данных и интеграции.",
        descEn: "Bigger builds: MVPs, dashboards, admin panels, roles, databases and integrations.",
        bulletsRu: ["Архитектура, фронт/бэк, деплой", "Авторизация, роли, платежи", "Админка, таблицы, фильтры", "Поддержка после запуска"],
      ...
      },
      {
        ...
        titleEn: "AUTOMATION",
        subtitleRu: "Интеграции / скрипты / рутина",
        subtitleEn: "Integrations / scripts / routine",
        ctaRu: "Рассчитать стоимость",
        ctaEn: "Get a quote",
        noteRu: "Без лишнего шума",
        noteEn: "No fluff",
        descRu: "Автоматизируем рутину: заявки, таблицы, отчёты, рассылки и интеграции.",
        descEn: "Automate routine: leads, sheets, reports, messaging and integrations.",
        bulletsRu: ["Make / Zapier / API интеграции", "Google Sheets / Notion / CRM", "Уведомления в Telegram", "Логи и стабильность"],
