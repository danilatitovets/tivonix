...
const EXAMPLES_RU: MilesealDemoExample[] = [
  {
    ...
    scope:
      "Редизайн главной и один раунд правок для маркетингового сайта. Миграция статей и страницы авторов не входят в объём. Только демонстрация — не кейс миграции контента на 56 часов.",
...
const COPY: Record<Lang, MilesealCopy> = {
  ...
  ru: {
    ...
    cta: {
      ...
      errEmail: "Укажите корректный рабочий адрес почты.",
