...
const PRODUCT_TYPES_RU: { id: ProductTypeId; label: string }[] = [
  ...
  { id: "fintech", label: "FinTech / платежи" },
...
const COPY_RU = {
  title: "Короткий product brief",
  subtitle:
    "За 1–2 минуты опишите продукт, пользователей и главный workflow. В ответ пришлём следующий шаг, риски, срок и диапазон стоимости.",
  ...
  errors: {
    ...
    task: "Опишите главный workflow или задачу (хотя бы пару слов).",
    consent: "Нужно согласие с политикой конфиденциальности.",
  },
  successTitle: "Brief получен",
  success:
