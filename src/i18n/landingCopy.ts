...
const COPY_RU = {
  hero: {
    eyebrow: "ПРОДУКТОВАЯ ИНЖЕНЕРИЯ ОТ ОСНОВАТЕЛЯ",
    titleLines: ["ПРОЕКТИРУЕМ И ЗАПУСКАЕМ", "ПРОГРАММНЫЕ ПРОДУКТЫ"],
    titleHighlight: "ПРОГРАММНЫЕ ПРОДУКТЫ",
    scrollStages: [
      {
        headline: "Проектируем и запускаем программные продукты — от архитектуры до боевого запуска",
        ...
        headlineAfter: "",
        lead: "TIVONIX берёт на себя формулировку продукта, UX, архитектуру, клиентскую и серверную части, интеграции, запуск и передачу системы.",
      },
      {
        headline: "Не передача кусков. Рабочая система.",
        headlineLines: ["Не передача кусков.", "Рабочая система."],
        headlineBefore: "Не передача кусков.",
        headlineAccent: "Рабочая система.",
        headlineAfter: "",
        lead: "Клиент покупает не часы дизайнера или разработчика. Он получает одного старшего технического владельца результата.",
      },
      {
        headline: "Роли, процессы, платежи, данные и запуск",
        headlineLines: ["Роли, процессы,", "платежи и запуск"],
        headlineBefore: "Роли, процессы,",
        headlineAccent: "платежи и запуск",
        headlineAfter: "",
        lead: "SaaS, финтех, маркетплейсы, системы уровня CRM/ERP, порталы, AI-автоматизация и продукты в Телеграме собираются как единый продуктовый контур.",
      },
    ],
    subtitle:
      "Продуктовая инженерия от основателя — для компаний, которым нужен один старший технический владелец результата: от формулировки продукта до боевого запуска.",
    ctaPrimary: "Обсудить продукт",
    ctaSecondary: "Продукты, которые уже онлайн",
    micro: "Ответим в течение рабочего дня · Сначала объём и риски · Код, доступы и передача — у клиента",
    flowNodes: ["Продукт", "Процессы", "Интеграции", "Запуск"],
    flowNodeHints: ["Цель", "Роли и шаги", "API и оплаты", "Релиз"],
    flowTelegramBot: "TIVONIX Бриф",
    flowDisplayChips: ["SaaS", "Админ", "Оплаты"],
    flowAnalysis: {
      headline: "Продукт разобран",
      lead: "Фиксируем пользователей, главный сценарий, роли, данные, интеграции и риски запуска до того, как писать код.",
      routeLabel: "Маршрут:",
      routeText: "бриф → объём → архитектура → разработка → релиз.",
      modulesLabel: "Состав:",
    },
    flowTelegramDetail: {
      sourceLabel: "Источник",
      sourceValue: "бриф продукта",
      actionLabel: "Действие",
      actionValue: "сценарий, роли и интеграции вынесены в объём работ",
    },
    flowCrmDetail: {
      summary: "Рабочая система уже онлайн: роли, данные, интеграции и передача не остаются в голове подрядчика.",
    },
    flowScenarios: [
      {
        prompt: "Нужен SaaS MVP с ролями",
        chips: ["SaaS", "Вход", "Админ"],
        notify: "Объём зафиксирован",
        result: {
          kind: "crm" as const,
          title: "Новая заявка",
          lines: [
            { label: "Роли", value: "Клиент · Админ" },
            { label: "Процесс", value: "Ввод в работу" },
            { label: "Статус", value: "Объём" },
          ],
        },
      },
      {
        prompt: "Нужно мини-приложение в Телеграме",
        chips: ["Телеграм", "Оплаты", "Админ"],
        notify: "Интеграции выделены",
        result: {
          kind: "telegram" as const,
          title: "Телеграм",
          lines: [
            { label: "Формат", value: "Мини-приложение" },
            { label: "Оплата", value: "Провайдер" },
            { label: "Админ", value: "Модерация" },
          ],
        },
      },
      {
        prompt: "Нужен маркетплейс",
        chips: ["Каталог", "Роли", "Бронирование"],
        notify: "Процессы описаны",
        result: {
          kind: "telegram" as const,
          title: "Телеграм",
          lines: [
            { label: "Покупатель", value: "Поиск" },
            { label: "Продавец", value: "Кабинет" },
            { label: "Админ", value: "Проверка" },
          ],
        },
      },
      {
        prompt: "Нужна внутренняя система",
        chips: ["Права", "Процессы", "Отчёты"],
        notify: "Границы системы ясны",
        result: {
          kind: "crm" as const,
          title: "Новая заявка",
          lines: [
            { label: "Пользователи", value: "Операционная команда" },
            { label: "Данные", value: "PostgreSQL" },
            { label: "Статус", value: "Спроектировано" },
          ],
        },
      },
      {
        prompt: "Хотим AI-автоматизацию",
        chips: ["AI", "Правила", "Резервный путь"],
        notify: "Ограничители добавлены",
        result: {
          kind: "crm" as const,
          title: "Новая заявка",
          lines: [
            { label: "Вход", value: "Документы" },
            { label: "Контроль", value: "На сервере" },
            { label: "Статус", value: "Безопасно" },
          ],
        },
      },
    ],
    visualStatus: [
      { main: "Формулируем продукт…", sub: "Пользователи, процессы, риски" },
      { main: "Архитектура собрана", sub: "Данные, роли, интеграции" },
      { main: "Боевой запуск", sub: "Передача и поддержка" },
    ],
  },
  pain: {
    ...
    subtitle:
      "Серьёзные системы ломаются не на кнопках. Они ломаются между ролями, данными, интеграциями, платежами, админкой и ответственностью за запуск.",
    hoverCta: "Как снижаем риск",
    items: [
      {
        title: "Нет технического владельца",
        text: "Дизайн, клиентская часть, серверная часть и интеграции живут у разных людей — никто не отвечает за итоговую систему целиком.",
        solution: "TIVONIX ведёт продукт как один контур: объём, UX, архитектура, реализация, запуск и передача.",
      },
      {
        title: "Процессы не продуманы",
        text: "Экраны выглядят нормально, но реальные роли, статусы, ошибки и крайние случаи появляются слишком поздно.",
        solution: "Сначала описываем пользователей, основной сценарий, состояния, ограничения и ручные обходные пути.",
      },
      {
        title: "Интеграции становятся сюрпризом",
        text: "Платежи, Телеграм, CRM, почта, таблицы, старые API и аналитика всплывают после оценки и ломают срок.",
        solution: "Выносим интеграции в объём заранее: что критично для первой версии, что можно отложить, где нужны заглушки.",
      },
      {
        title: "Передачу откладывают на потом",
        text: "Проект вроде запущен, но код, доступы, инструкция, переменные и ответственность остаются неясными.",
        solution: "Передача кода, доступов, окружений и правил поддержки закладывается до релиза, а не после него.",
      },
    ],
  },
  offer: {
    title: "Ответственность за продукт целиком",
    featured: {
      badge: "TIVONIX",
      title: "Один владелец результата: от формулировки продукта до боевого запуска",
      text: "Собираем системы, где пользовательские роли, процессы, серверная часть, данные, интеграции, интерфейс и запуск работают как один продукт.",
      linkText: "Обсудить продукт",
      footer: "Сначала фиксируем объём, риски и первый готовый к запуску сценарий",
    },
    metrics: [
      {
        title: "SaaS и MVP",
        text: "Первый рабочий продукт с пользователями, ролями, данными, админкой и понятной траекторией развития.",
      },
      {
        title: "Финтех и платёжные сценарии",
        text: "Каталоги, кошельки, платёжные сценарии, вторичный рынок, логика оператора и админа, проверяемые состояния.",
      },
      {
        title: "Маркетплейсы и порталы",
        text: "Многосторонние продукты: роли, каталоги, заявки, бронирование, кабинеты, модерация и админ-панели.",
      },
      {
        title: "Внутренние платформы",
        text: "Системы уровня CRM/ERP, операционные панели, отчёты, история изменений, уведомления и поддержка процессов.",
      },
      {
        title: "AI и автоматизация",
        text: "AI как рабочая функция продукта: ключи на сервере, проверки, резервный путь, контроль расходов и понятная ответственность.",
      },
    ],
    ctaBar: {
      title: "Соберём не презентацию продукта, а рабочую систему с понятным владельцем результата.",
      primary: "Обсудить продукт",
      secondary: "Собрать бриф",
    },
  },
  ai: {
    ...
    tags: ["Разбор заявок", "Документы", "Ограничители", "CRM", "Поддержка"],
  },
  flow: {
    ...
    steps: [
      ...
      },
      {
        ...
        desc: "Статусы, реестр операций, история, журнал изменений",
      },
      {
        label: "Интеграции",
        title: "Интеграции и границы",
        desc: "Оплаты, Телеграм, CRM, почта, API",
      },
      {
        label: "Релиз",
        title: "Запуск и передача",
        desc: "Развёртывание, проверка, доступы, поддержка",
      },
    ],
  },
  pricingTeaser: {
    eyebrow: "Коммерческая модель",
    title: "Сложные системы считаем по объёму. Пакеты запуска — отдельно.",
    more: "Подробнее",
  },
  compare: {
    title: "Обычный подрядчик и TIVONIX",
    subtitle: "Разница не в количестве экранов, а в том, кто отвечает за продуктовую логику, серверную часть, интеграции и запуск.",
    regular: {
      title: "Разрозненная передача",
      headline: "Красивые экраны — дальше вручную",
      items: [
        "Интерфейс передан",
        "Серверная часть отдельно",
        "Интеграции потом",
        "Статусы не описаны",
        "Передача неясна",
      ],
    },
    chaosTags: ["Нет владельца", "Объём расползается", "Риски поздно", "Запуск болит"],
    tivonix: {
      title: "Продуктовая инженерия TIVONIX",
      headline: "Один контур результата",
      badge: "Объём, архитектура, UX, код, интеграции и релиз связаны в одну линию",
      items: [
        "Главный сценарий сформулирован",
        "Роли и данные описаны заранее",
        "Серверная часть и админка входят в план",
        "Интеграции вынесены в объём работ",
        "Запуск и передача проверяются",
      ],
    },
  ...
  cases: {
    ...
    tivonixpanel: {
      ...
      done: "Собрали вход, ввод в работу, панель сделок, реферальную модель и работу под вашим брендом, учёт проектов и выплат",
      modules: [
        "Вход",
        "Ввод в работу",
        "Панель сделок",
  ...
  audience: {
    ...
    callouts: {
      ...
      right: {
        text: "Instagram, Телеграм, сайт и звонки — все обращения в одном процессе.",
      },
    },
    pins: [
    ...
    pillars: [
      ...
      {
        title: "Быстрый ответ",
        text: "Уведомления в Телеграм, статусы — клиент не ждёт и не уходит.",
      },
      {
    ...
    items: [
      ...
      { title: "Эксперты и консультанты", desc: "Заявки с лендинга сразу в Телеграм и CRM" },
    ...
    steps: [
      {
        ...
        items: [
          "Определяем пользователя, бизнес-контекст, главный сценарий и критерий готовности первой версии.",
        ],
      },
      {
        kind: "bullets",
        title: "Фиксируем объём и риски",
        items: [
          "Письменно разделяем обязательное, отложенное, интеграции, ограничения, сроки и стоимость этапа.",
        ],
      },
      {
        kind: "bullets",
        ...
        items: [
          "Связываем экраны, роли, данные, состояния, API и условия запуска до активной разработки.",
        ],
      },
      {
        kind: "bullets",
        title: "Разрабатываем рабочими частями",
        items: [
          "Показываем не картинки, а работающие части системы: интерфейс, серверную часть, админку, интеграции и состояния.",
        ],
      },
      {
        kind: "bullets",
        title: "Проверяем критичные для релиза сценарии",
        items: [
          "Проверяем мобильный UX, доступы, формы, роли, платежи, интеграции, поведение при ошибках и SEO.",
        ],
      },
      {
        kind: "bullets",
        ...
        items: [
          "Передаём код, доступы, настройки окружений и инструкции. Поддержка и развитие фиксируются отдельно.",
        ],
      },
  ...
  finalCta: {
    ...
    subtitle:
      "Опишите продукт, пользователей, процессы и интеграции. В ответ пришлём следующий шаг, риски, срок и диапазон стоимости.",
    ctaPrimary: "Отправить бриф",
    ctaSecondary: "Посмотреть, что уже работает",
  ...
  packages: {
    ...
    launch: {
      ...
      subtitle: "Лендинг + форма + Телеграм",
      ...
      bullets: [
        ...
        "Форма заявки",
        "Кнопки связи",
        "Уведомления в Телеграм или на почту",
        "Адаптив под телефон",
        "Базовая аналитика",
        "Запуск",
      ],
    ...
    automation: {
      ...
      bullets: [
        ...
        "Связка Телеграма, почты и таблиц",
        "Мини-CRM",
        "Статусы задач",
        "Уведомления команде",
        "Отчёты",
