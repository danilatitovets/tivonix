...
const COPY_RU = {
  hero: {
    ...
    subtitle:
      "Разрабатываем сайты, ботов, CRM и автоматизацию — и связываем их в один процесс: от первой заявки до оплаты и результата.",
...
const COPY_EN = {
  hero: {
    ...
    subtitle:
      "We design and build MVPs, client portals, dashboards and automations for founders and agencies. Fixed scope, written progress updates and full source-code ownership.",
...
const COPY_ZH = {
  hero: {
    ...
    subtitle:
      "为创始人和代理机构设计并构建 MVP、客户门户、仪表盘与自动化。范围固定、书面进度更新、完整源代码归属。",
