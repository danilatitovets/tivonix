...
const RU: PartnersCopy = {
  seo: {
    title: "Партнёрская программа TIVONIX — реферальная модель и работа под вашим брендом",
    description:
    ...
    serviceName: "TIVONIX Partners — реферальная модель и работа под вашим брендом",
  ...
  models: {
    ...
    menu: [
      ...
      { title: "Под вашим брендом", description: "Продаёте как услугу агентства" },
      { title: "Реферальная модель", description: "Вознаграждение после оплаты" },
    ...
    referral: {
      ...
      cta: "Стать реферальным партнёром",
    ...
    whiteLabel: {
      ...
      cta: "Работать под своим брендом",
  ...
  afterReg: {
    ...
    steps: [
      { t: "Вы выбираете формат", d: "Реферальная модель или работа под вашим брендом." },
  ...
  cases: {
    ...
    texts: {
      ...
      slotty:
        "Маркетплейс онлайн-записи: каталог с картой, мини-приложение в Телеграме, кабинет исполнителя, админка платформы и оплаты.",
      logovo:
        "Сайт сети шиномонтажа под ключ: 4 филиала, карта, запись, B2B для автопарков, 11 услуг — уже онлайн на logovo24.by.",
      headmind:
        "Корпоративный сайт консалтинговой компании: Figma → WordPress, услуги, команда, формы заявок — уже онлайн на headmind.ru.",
      tivonixpanel:
  ...
  examples: {
    sr: "Примеры реферальной модели и работы под вашим брендом",
    referral: {
      pill: "Реферальная модель",
      title: "Пример реферальной модели",
    ...
    whiteLabel: {
      pill: "Под вашим брендом",
      title: "Пример работы под вашим брендом",
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Чем реферальная модель отличается от работы под вашим брендом?",
        a: "В реферальной модели вы передаёте клиента, TIVONIX ведёт сделку и платит вознаграждение после оплаты. Под своим брендом вы продаёте разработку как услугу агентства и сами назначаете цену клиенту.",
      },
      {
        q: "Кто общается с клиентом?",
        a: "Под вашим брендом основную коммуникацию ведёте вы. В реферальной модели мы можем общаться напрямую в согласованном формате.",
      },
      {
      ...
      },
      {
        ...
        a: "При работе под вашим брендом — только с вашего согласия. В реферальной модели формат общения согласуем заранее.",
      },
      {
      ...
      },
      {
        ...
        a: "Заявка уходит на проверку и ждёт решения. После одобрения — условия сотрудничества и доступ к панели.",
      },
      {
