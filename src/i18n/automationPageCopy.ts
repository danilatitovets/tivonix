...
const ru: AutomationPageCopy = {
    ...
    slides: [
      {
        ...
        text: "Соберём заявки с сайта, форм, Телеграма, почты и других источников в одном месте.",
        image: "1.webp",
      },
      {
      ...
      },
      {
        ...
        text: "Настроим автоматические уведомления в Телеграм, на почту или внутри системы.",
        image: "5.webp",
      },
      {
        title: "Отчёты и аналитика",
        text: "Соберём ключевые показатели в удобные панели и понятные отчёты.",
        image: "6.webp",
      },
      {
      ...
      },
      {
        ...
        text: "Свяжем сайт, CRM, Телеграм, таблицы, платёжные системы, API и другие инструменты.",
        image: "8.webp",
      },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Вы делаете интеграции с Телеграмом, оплатами и внешними сервисами?",
        a: "Да. Мы можем подключить Телеграм, почту, платёжные системы, CRM, таблицы, API и другие сервисы.",
      },
      {
