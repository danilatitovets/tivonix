...
const COPY_RU = {
  ...
  featured: {
    eyebrow: "Проекты",
    title: "Product proof, не портфолио",
    subtitle: "Живые системы, где видны роли, workflow, backend, интеграции и production-ответственность.",
  ...
  homePricing: {
    eyebrow: "Тарифы",
    title: "Complex Product Engineering — scope-based. Launch Packages — отдельно.",
    note: "Сложные SaaS, fintech, marketplaces и internal systems оцениваются после brief. Недорогие launch-пакеты остаются для коротких задач, но не определяют весь TIVONIX.",
  ...
  founder: {
    title: "Founder-led ownership вместо безликой студии",
    name: "Данила Титовец",
    role: "Founder / Product architecture / Full-stack",
    bio: "Данила отвечает за технический результат: product framing, архитектуру, разработку, интеграции, QA, release и handover. При необходимости подключает проверенных специалистов под конкретную задачу.",
    cta: "Написать основателю",
  },
  team: {
    title: "Delivery functions, а не выдуманная команда",
    text: "TIVONIX работает как founder-led product engineering: одна ответственность за результат, а функции delivery закрываются внутри проекта или подключаются точечно под scope.",
    cta: "О компании",
    members: [
      { initials: "UX", name: "Product & UX", role: "Фрейминг, сценарии, интерфейсы" },
      { initials: "FE", name: "Frontend", role: "React, states, responsive, performance" },
      { initials: "BE", name: "Backend & data", role: "API, база, роли, интеграции" },
      { initials: "QA", name: "Quality", role: "Сценарии, формы, ошибки, доступность" },
      { initials: "RL", name: "Release", role: "Деплой, env, SEO, handover" },
      { initials: "PS", name: "Support", role: "Запуск, гарантия, развитие" },
    ],
  },
  testimonials: {
    eyebrow: "Отзывы",
