...
const COPY_RU = {
  ...
  featured: {
    eyebrow: "Проекты",
    title: "Работающие продукты, а не портфолио",
    subtitle: "Живые системы, где видны роли, процессы, серверная часть, интеграции и ответственность за запуск.",
    ...
    resultLabel: "Результат:",
      ...
      },
      {
        ...
        solution:
          "Собрали каталог с фильтрами и картой, мини-приложение в Телеграме, кабинет мастера с тарифами Free/Pro, админку и bePaid.",
        result:
  ...
  direction: {
    ...
    leads: {
      ...
      cta: "Разобрать путь",
      points: ["Сайт и лендинг", "Бот в Телеграме", "Мини-CRM"],
      stack: [
        {
          title: "Сайт",
  ...
  homePricing: {
    eyebrow: "Тарифы",
    title: "Сложные продукты — по объёму. Пакеты запуска — отдельно.",
    note: "Сложные SaaS, финтех, маркетплейсы и внутренние системы оцениваем после брифа. Недорогие пакеты запуска остаются для коротких задач, но не определяют весь TIVONIX.",
    ...
    ctas: {
      ...
      custom: "Обсудить разработку продукта",
    },
  },
  guarantees: {
  ...
  founder: {
    title: "Личная ответственность основателя вместо безликой студии",
    name: "Данила Титовец",
    role: "Основатель / Архитектура продукта / Разработка полного цикла",
    bio: "Данила отвечает за технический результат: формулировку продукта, архитектуру, разработку, интеграции, тестирование, релиз и передачу. При необходимости подключает проверенных специалистов под конкретную задачу.",
    cta: "Написать основателю",
  },
  team: {
    title: "Роли в проекте, а не выдуманная команда",
    text: "TIVONIX работает как продуктовая инженерия под руководством основателя: одна ответственность за результат, а нужные роли закрываются внутри проекта или подключаются точечно под объём работ.",
    cta: "О компании",
    members: [
      { initials: "UX", name: "Продукт и UX", role: "Постановка, сценарии, интерфейсы" },
      { initials: "FE", name: "Клиентская часть", role: "React, состояния, адаптив, скорость" },
      { initials: "BE", name: "Серверная часть и данные", role: "API, база, роли, интеграции" },
      { initials: "QA", name: "Качество", role: "Сценарии, формы, ошибки, доступность" },
      { initials: "RL", name: "Релиз", role: "Развёртывание, окружения, SEO, передача" },
      { initials: "PS", name: "Поддержка", role: "Запуск, гарантия, развитие" },
    ],
  },
  testimonials: {
    eyebrow: "Отзывы",
  ...
  scale: {
    ...
    foot: "Сайты, Телеграм, CRM, кабинеты и MVP в одной связке. Фиксируем объём, сроки и передаём код с доступами.",
    stats: [
      { value: "7+", label: "Проектов уже онлайн" },
...
const COPY_EN = {
  ...
  featured: {
    eyebrow: "Projects",
    title: "Product proof, not portfolio",
    subtitle: "Live systems where roles, workflows, backend, integrations and production ownership are visible.",
    viewCase: "View case",
    openLive: "Open live",
    problem: "Problem:",
    solution: "Solution:",
  ...
  homePricing: {
    eyebrow: "Pricing",
    title: "Complex Product Engineering is scope-based. Launch Packages stay separate.",
    note: "Complex SaaS, fintech, marketplaces and internal systems are estimated after a brief. Smaller launch packages remain for short tasks, but they do not define TIVONIX.",
  ...
  founder: {
    title: "Founder-led ownership instead of a faceless studio",
    name: "Danila Titovets",
    role: "Founder / Product architecture / Full-stack",
    bio: "Danila owns the technical outcome: product framing, architecture, engineering, integrations, QA, release and handover. Trusted specialists are added only when the scope requires it.",
    cta: "Message the founder",
  },
  team: {
    title: "Delivery functions, not an invented team",
    text: "TIVONIX works as founder-led product engineering: one responsibility for the outcome, with delivery functions covered inside the project or added precisely for the scope.",
    cta: "About the company",
    members: [
      { initials: "UX", name: "Product & UX", role: "Framing, scenarios, interfaces" },
      { initials: "FE", name: "Frontend", role: "React, states, responsive, performance" },
      { initials: "BE", name: "Backend & data", role: "API, database, roles, integrations" },
      { initials: "QA", name: "Quality", role: "Flows, forms, errors, accessibility" },
      { initials: "RL", name: "Release", role: "Deploy, env, SEO, handover" },
      { initials: "PS", name: "Support", role: "Launch, warranty, evolution" },
    ],
  },
  testimonials: {
...
const COPY_ZH = {
  ...
  featured: {
    eyebrow: "项目",
    title: "Product proof，而不是作品集",
    subtitle: "已上线系统：能看到角色、流程、后端、集成与 production 责任。",
    viewCase: "查看案例",
    openLive: "打开线上项目",
    problem: "问题：",
    solution: "方案：",
  ...
  homePricing: {
    eyebrow: "价格",
    title: "复杂 Product Engineering 按范围评估；Launch Packages 单独保留",
    note: "复杂 SaaS、金融科技、市场平台与内部系统在 brief 后评估。小型 launch packages 仍适合短任务，但不定义整个 TIVONIX。",
    allPlans: "对比全部方案",
    more: "详情",
    ctas: {
      start: "获取 Start 范围",
  ...
  founder: {
    title: "Founder-led ownership，而不是无名工作室",
    name: "Danila Titovets",
    role: "Founder / Product architecture / Full-stack",
    bio: "Danila 对技术结果负责：产品梳理、架构、工程、集成、QA、上线与交接。只有在 scope 需要时才引入可信专家。",
    cta: "联系创始人",
  },
  team: {
    title: "Delivery functions，不是虚构团队",
    text: "TIVONIX 采用 founder-led product engineering：一个结果责任人，delivery functions 在项目内覆盖，或按 scope 精准加入。",
    cta: "关于公司",
    members: [
      { initials: "UX", name: "Product & UX", role: "梳理、场景、界面" },
      { initials: "FE", name: "Frontend", role: "React、状态、响应式、性能" },
      { initials: "BE", name: "Backend & data", role: "API、数据库、角色、集成" },
      { initials: "QA", name: "Quality", role: "流程、表单、错误、可访问性" },
      { initials: "RL", name: "Release", role: "部署、env、SEO、交接" },
      { initials: "PS", name: "Support", role: "上线、保修、演进" },
    ],
  },
  testimonials: {
    eyebrow: "客户评价",
